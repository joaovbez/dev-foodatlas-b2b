  ...
  useEffect(() => {
    async function loadRestaurantData() {
      try {
        ...
        const filesResponse = await fetch(`/api/restaurants/${id}/files?limit=5`)
        if (filesResponse.ok) {
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button 
                ...
                onClick={() => router.push(`/conta/restaurants/${id}/edit`)}
              >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" onClick={() => router.push(`/conta/restaurants/${id}/files`)}>
            ...
            {recentFiles.length === 0 ? (
              <div className="rounded-lg border-2 border-dashed p-6 text-center">
                ...
                <Button
                  onClick={() => router.push(`/conta/restaurants/${id}/files`)}
                  className="mt-4"
                >
                  Gerenciar Arquivos
                </Button>
